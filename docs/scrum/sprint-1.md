...
| PB-27 | Minstens 1 netwerkopstelling opslaan in SQLite | Joost | `modules/database_tools.py`, `database/schema.sql` | To do |
| PB-28 | Functie maken om users te controleren | Joost | `modules/database_tools.py` | To do |
| PB-29 | Functie maken om network_setups op te halen | Joost | `modules/database_tools.py` | To do |
| PB-30 | Functie maken om deployment_logs op te slaan | Joost | `modules/database_tools.py` | To do |
| PB-31 | Loginroute koppelen aan SQLite | Lina + Joost | `app.py`, `modules/database_tools.py`, `templates/login.html` | To do |
