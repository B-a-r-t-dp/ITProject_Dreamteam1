...
| PB-51 | Docker Compose build/start documenteren | De stappen om Docker-images te bouwen en containers te starten worden duidelijk uitgelegd. | Bart | `Dockerfile`, `docker-compose.yml`, `servers/`, technisch document | To do |
...
| PB-54 | Netwerk/Ansible-beperkingen documenteren | We leggen uit wat setup1 en setup2 configureren, welke basisconfiguratie nodig is en wat bewust beperkt blijft. | Bart | `ansible/playbooks/`, setupdocumentatie, technisch document | To do |
